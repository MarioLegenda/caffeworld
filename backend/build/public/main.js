...
var map = {
	"./caffeeworld/module/room/room.module": [
		"./src/app/caffeeworld/module/room/room.module.ts",
		"caffeeworld-module-room-room-module"
	]
};
            ...
            providers: [
                {
                    ...
                    useFactory: function (observableFactory) { return new _caffeeworld_infrastructure_AppSocket__WEBPACK_IMPORTED_MODULE_12__["default"](_environments_environment__WEBPACK_IMPORTED_MODULE_13__["environment"].siteUrl + '/', { path: '/socket', reconnectionAttempts: 5 }, observableFactory); },
...
var CaffeeworldModule = /** @class */ (function () {
    ...
    CaffeeworldModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            exports: [_caffeeworld_component__WEBPACK_IMPORTED_MODULE_7__["CaffeeworldComponent"]],
            providers: [
...
var TableSocketService = /** @class */ (function () {
    ...
    TableSocketService.prototype.onTableCreated = function () {
...
module.exports = ".not-found {\n  margin-top: 50px; }\n  .not-found .title {\n    font-family: \"Amatic SC\", cursive;\n    font-size: 5em;\n    text-align: center;\n    color: #f46525; }\n  .not-found .not-found-status {\n    color: #f46525;\n    font-weight: bolder;\n    font-size: 10em;\n    text-align: center;\n    font-family: \"Amatic SC\", cursive;\n    margin-top: 50px; }\n  .not-found .text {\n    font-size: 2em;\n    text-align: center;\n    margin-top: 50px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".create-room {\n  margin-top: 50px; }\n  .create-room .form {\n    margin-top: 50px; }\n  .create-room h4 {\n    text-align: center;\n    border-bottom: #d3d3d3;\n    font-family: \"Amatic SC\", cursive;\n    font-size: 3em;\n    word-spacing: 0.2em;\n    margin-bottom: 80px; }\n  .create-room .intro-text {\n    font-size: 1.2em;\n    text-align: center;\n    margin: 0 auto;\n    margin-bottom: 20px; }\n  .create-room .intro-text a {\n      color: #f46525;\n      font-weight: bold; }\n  .create-room .intro-text:last-child {\n    color: #f46525;\n    font-weight: bold;\n    font-family: \"Amatic SC\", cursive;\n    font-size: 2.5em; }\n  .create-room .form-element {\n    margin: 0 auto;\n    margin-bottom: 40px;\n    position: relative;\n    padding: 15px;\n    border-bottom: 1px solid #d3d3d3; }\n  .create-room .form-element .label-mandatory {\n      color: red;\n      margin-left: 5px; }\n  .create-room .form-element .input-info-message {\n      display: block;\n      float: right;\n      color: #f46525;\n      font-style: italic;\n      text-align: right; }\n  .create-room .form-element .max-length-message {\n      width: 100%;\n      display: block;\n      float: left;\n      font-size: 0.9em;\n      margin-left: 14px; }\n  .create-room .form-element .info-message {\n      width: 100%;\n      display: block;\n      float: left;\n      font-size: 0.9em;\n      margin-left: 14px;\n      margin-top: 15px;\n      font-style: italic; }\n  .create-room .form-element .field-info {\n      position: absolute;\n      color: gray;\n      top: 10px;\n      right: 20px;\n      font-size: 2em; }\n  .create-room .form-element .label {\n      float: left;\n      font-size: 1.2em;\n      margin-top: 11px; }\n  .create-room .form-element .input {\n      float: right;\n      padding: 25px;\n      font-size: 1.2em;\n      border: 1px solid #d3d3d3; }\n  .create-room .form-element .textarea {\n      border: 1px solid #d3d3d3;\n      border-radius: 20px;\n      font-size: 1.2em;\n      display: block;\n      float: left;\n      margin-top: 20px; }\n  .create-room .form-element .error {\n      float: left;\n      padding: 0;\n      padding-top: 13px;\n      position: relative; }\n  .create-room .form-element .error i {\n        position: absolute;\n        top: 15px;\n        right: 15px; }\n  .create-room .form-element .unrecoverable-error {\n      border-radius: 40px;\n      float: right;\n      margin-top: 30px; }\n  .create-room .btn-get-a-table {\n    font-size: 1.2em;\n    display: block;\n    float: right;\n    border-radius: 40px; }\n  .create-room .btn-get-a-table:disabled {\n    background-color: #fcc0a6; }\n  .create-room .btn-get-a-table:disabled:hover {\n      box-shadow: none;\n      background-color: #fcc0a6 !important;\n      cursor: default; }\n  .create-room .btn:disabled {\n    background-color: #fcc0a6;\n    opacity: 1 !important; }\n  .create-room .coffee-date {\n    float: left !important; }\n  .modal-header h5 {\n  font-weight: normal;\n  text-align: left; }\n  .modal-body .modal-share-wrapper {\n  width: 100%;\n  float: left;\n  position: relative;\n  padding: 20px 0 20px 0; }\n  .modal-body .modal-share-button {\n  width: 20%;\n  float: right;\n  border-radius: 40px; }\n  .modal-body .modal-url {\n  width: 70%;\n  float: left;\n  padding: 10px;\n  border: 1px solid #d3d3d3; }\n  .modal-body .content-copied {\n  position: absolute;\n  width: 90px;\n  opacity: 1;\n  bottom: 0;\n  right: 136px;\n  border: 1px solid #d3d3d3;\n  padding: 10px;\n  border-radius: 40px;\n  background-color: white;\n  text-align: center; }\n  .modal-footer {\n  display: block; }\n  .modal-footer .modal-go-to-table-button {\n    display: block;\n    font-size: 1.2em;\n    float: right !important;\n    border-radius: 40px; }\n  @-webkit-keyframes fadeOut {\n  from {\n    opacity: 1; }\n  to {\n    opacity: 0; } }\n  @keyframes fadeOut {\n  from {\n    opacity: 1; }\n  to {\n    opacity: 0; } }\n  .animated {\n  -webkit-animation-duration: 0.5s;\n          animation-duration: 0.5s;\n  -webkit-animation-fill-mode: both;\n          animation-fill-mode: both; }\n  @-webkit-keyframes fadeIn {\n  from {\n    opacity: 0; }\n  to {\n    opacity: 1; } }\n  @keyframes fadeIn {\n  from {\n    opacity: 0; }\n  to {\n    opacity: 1; } }\n  .fadeIn {\n  -webkit-animation-name: fadeIn;\n          animation-name: fadeIn; }\n  .fadeOut {\n  -webkit-animation-name: fadeOut;\n          animation-name: fadeOut; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var CreateComponent = /** @class */ (function () {
    ...
    CreateComponent.prototype.onSubmit = function (isValid, content) {
        var _this = this;
        if (isValid) {
            this.tableSocketService.emitCreateTable(this.createTableModel);
            this.tableSocketService.onTableCreated().subscribe(function (data) {
                _this.roomData = data;
...
var environment = {
    production: false,
    siteUrl: 'https://dev.gocaffeworld.com'
};
