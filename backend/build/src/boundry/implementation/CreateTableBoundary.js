...
let CreateTableBoundary = class CreateTableBoundary {
...
CreateTableBoundary = __decorate([
    ...
    __param(0, inversify_1.inject(Symbols_1.Symbols.TableInterpreter)),
    __metadata("design:paramtypes", [TableInterpreter_1.default])
], CreateTableBoundary);
exports.default = CreateTableBoundary;
